 ...
 * @LastEditors: abc
 * @LastEditTime: 2021-10-04 23:05:47
 * @Description: 
-->
<template>
  <div class="other">
        ...
        <div class="home-new">
          <el-row type="flex" justify="space-between" align="middle">
            <el-col :xs="23" :lg="8">
              ...
              <h2 class="bass-h2 wow fadeInUp">{{ $t('bass.wallet') }}</h2>
          ...
          <div class="home-new">
            <el-row type="flex" justify="space-between" align="middle">
              ...
              <el-col :xs="23" :lg="8">
                ...
                <h2 class="bass-h2 wow fadeInUp">{{ $t('bass.signed') }}</h2>
                <p class="wow fadeInUp">
                  {{ $t('bass.signature') }}
                </p>
              </el-col>
          ...
          <div class="home-new">
            <el-row type="flex" justify="space-between" align="middle">
              <el-col :xs="23" :lg="8">
                ...
                <h2 class="bass-h2 wow fadeInUp">{{ $t('bass.safer') }}</h2>
                <p class="wow fadeInUp">
                  {{ $t('bass.compared') }}
                </p>
              </el-col>
    ...
    <div id="smart" class="media-a high-bottom">
      <el-row type="flex" justify="center">
        <el-col :xs="23" :lg="18">
