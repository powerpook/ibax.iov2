 ...
 * @LastEditors: abc
 * @LastEditTime: 2021-09-15 17:34:05
 * @Description: 
-->
<template>
  <div class="other">
    <el-row type="flex" justify="center">
      <el-col :xs="23" :sm="22" :md="20" :lg="18">
        ...
        <div class="home-new">
          ...
          <el-row type="flex" justify="space-between" align="middle">
            <el-col :xs="23" :lg="8">
              <h2 class="bass-h2 wow fadeInUp">{{ $t('feature.eco') }}</h2>
      ...
      <el-row type="flex" justify="center">
        <el-col :xs="23" :lg="15">
          ...
          <div class="other-center-span wow fadeInUp">
            <strong class="other-center-strong">{{
              $t('feature.business')
            }}</strong>
            {{ $t('feature.tokens') }}
          </div>
          ...
          <div class="home-new">
            <el-row type="flex" justify="space-between" align="middle">
              ...
              <el-col :xs="23" :lg="8">
                ...
                <h2 class="bass-h2 wow fadeInUp">{{ $t('feature.gas') }}</h2>
                <p class="wow fadeInUp">
          ...
          <div class="home-new">
            <el-row type="flex" justify="space-between" align="middle">
              <el-col :xs="23" :lg="8">
                ...
                <h2 class="bass-h2 wow fadeInUp">{{ $t('feature.based') }}</h2>
                <p class="wow fadeInUp">
                  {{ $t('feature.use') }}
                </p>
              </el-col>
